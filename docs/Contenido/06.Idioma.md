...
* Aplica la <a
  ...
  class="margin-toggle"/><span class="sidenote">Por donde nos parte
...
Siguiente: <a href="{{ site.github.url }}/Contenido/07.html">X</a> [<a href="{{ site.github.url }}/">Contenido</a>]</p>
</div>
