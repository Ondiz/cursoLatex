...
y negro. Como en el resto de casos, para usar colores en LaTeX
...
Especialmente útil cuando queremos combinar los colores del texto con
alguno específico de una imagen o si las opciones `dvipsnames` y
`svgnames` no nos funcionan por algún motivo. En la página
[*LaTeX color*][latexColor] hay montones de definiciones de colores
para que empecemos a jugar.
...
src="https://www.youtube.com/embed/HnSQFaHvxTI?list=PLw8I74P--tlVmX53NXBA_YtzoovpSfdlU"
