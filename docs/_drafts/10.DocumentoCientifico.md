...
Muy importante la planificación. Muy importante.

* Paquetes

`nomencl`

`glossaries` que tiene un manual de 250 páginas

Usan `makeindex`

`listofsymbols`

Hasta me atreví a [añadirle funcionalidades][los] con mis limitadas
habilidades.
...
documento científico: el manejo de las referencias bibliográficas.

Va todo en texto plano y se pueden usar programas libres.
