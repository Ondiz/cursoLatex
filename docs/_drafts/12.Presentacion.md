...
* Mostrar elementos uno a uno. También funciona en las
  notas
...
Este es uno de esos momentos en los que LaTeX sea listo nos toca
ligeramente las narices. Por mucho *overlay* que tengamos, LaTeX
reserva espacio para las imágenes de antemano como si fueran a
aparecer todas al mismo tiempo. Esto es algo de agradecer en general,
pero no nos permite *apilar* las imágenes, algo interesante en una
presentación.
